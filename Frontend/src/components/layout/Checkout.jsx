  ...
  const onPlaceOrder = async (data) => {
    ...
    const order = {
      ...
      buyerLocation: {
        ...
        countryCode: data.countryCode || "",
        region: data.state || "",
        regionCode: data.stateCode || "",
        city: data.city || "",
        cityStateCode: data.stateCode || "",
        town: buyerLocation.countryCode === data.countryCode && String(buyerLocation.city || '').toLowerCase() === String(data.city || '').toLowerCase() ? buyerLocation.town || "" : "",
        townStateCode: buyerLocation.countryCode === data.countryCode && String(buyerLocation.city || '').toLowerCase() === String(data.city || '').toLowerCase() ? buyerLocation.townStateCode || "" : "",
