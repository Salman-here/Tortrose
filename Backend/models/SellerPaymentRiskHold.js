...
const sellerPaymentRiskHoldSchema = new mongoose.Schema(
  {
    ...
    providerEnvironment: { type: String, default: null, enum: ['sandbox', 'production', null] },
    paymentIntentId: { type: String, required() { return this.provider !== 'safepay'; }, trim: true, index: true },
    chargeId: { type: String, required() { return this.provider !== 'safepay'; }, trim: true, index: true },
